...
from core import TiList, TiString, is_complex_val, require_real, require_int, py_int, require_list, str_to_tokens
...
class Environment:
	...
	def __init__(self, console=None):
		...
		self.pics       = [None] * 10      # Pic1–Pic0, by catalog index (Bitmap | None)
