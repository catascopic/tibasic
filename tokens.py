...
token(0x1B, 'R►Pr(',        pure=pf.r_pr)
token(0x1C, 'R►Pθ(',        pure=pf.r_ptheta)
token(0x1D, 'P►Rx(',        pure=pf.p_rx)
token(0x1E, 'P►Ry(',        pure=pf.p_ry)
...
token(0xBB0C, 'sub(',           pure=pf.sub_string)
