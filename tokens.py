...
def token(
	...
	*,
	...
	t = Token(code, char, text, bp, op, post, func, cmd, res, cnv, var)
	ALL_TOKENS.append(t)
	if char:
		CHARS[char] = t
	return t
...
token(b'\xbb\xaf', '𝟊')
token(b'\xbb\xb0', char='a')
token(b'\xbb\xb1', char='b')
token(b'\xbb\xb2', char='c')
token(b'\xbb\xb3', char='d')
token(b'\xbb\xb4', char='e')
token(b'\xbb\xb5', char='f')
token(b'\xbb\xb6', char='g')
token(b'\xbb\xb7', char='h')
token(b'\xbb\xb8', char='i')
token(b'\xbb\xb9', char='j')
token(b'\xbb\xba', char='k')
token(b'\xbb\xbc', char='l')
token(b'\xbb\xbd', char='m')
token(b'\xbb\xbe', char='n')
token(b'\xbb\xbf', char='o')
token(b'\xbb\xc0', char='p')
token(b'\xbb\xc1', char='q')
token(b'\xbb\xc2', char='r')
token(b'\xbb\xc3', char='s')
token(b'\xbb\xc4', char='t')
token(b'\xbb\xc5', char='u')
token(b'\xbb\xc6', char='v')
token(b'\xbb\xc7', char='w')
token(b'\xbb\xc8', char='x')
token(b'\xbb\xc9', char='y')
token(b'\xbb\xca', char='z')
