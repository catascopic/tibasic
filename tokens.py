...
token(0x1B, 'R►Pr(',        pure=pf.rect_to_polar_radius)
token(0x1C, 'R►Pθ(',        pure=pf.rect_to_polar_angle)
token(0x1D, 'P►Rx(',        pure=pf.polar_to_rect_x)
token(0x1E, 'P►Ry(',        pure=pf.polar_to_rect_y)
